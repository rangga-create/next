...
import { Produk } from "@/app/produk/interface";
...
export default function LatihanDetailPage() {
 ...
 const { data, isLoading, isError, refetch } = useQuery({
    ...
    queryFn: () => produkService.detail(Number(id)),
  ...
  return (
    <div className="p-8">
      ...
      {data?.data && (
        ...
        <p className="text-gray-700">Harga : {data.data.harga}</p>
        <p className="text-gray-700">Deksripsi : {data.data.deskripsi}</p>
